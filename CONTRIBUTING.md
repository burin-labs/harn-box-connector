# Contributing to harn-box-connector

This repository does not accept external contributions.

## Why

`harn-box-connector` is a generated and fleet-managed connector package. It carries the
Box side of the Harn connector contract and almost nothing else. Its
...
- Found a bug in how this connector handles Box, or want a connector that
